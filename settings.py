...
DATABASE_NAME = os.path.join(SITE_ROOT, 'development.db')            # Or path to database file if using sqlite3.
...
SECRET_KEY = '-joiz_h+9su!cidu@5*0zhuux$*ilspw#okadop)#q*2k4wy0s'
